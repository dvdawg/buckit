-- Add performance and scoring features to existing schema
-- This migration adds all the features seen in the profile and performance pages
...
-- Add new fields to buckets table
...
-- Create user_activity table for streak tracking
...
-- Create weekly_progress table for performance analytics
...
-- Create bucket_progress table for bucket-specific analytics
...
-- Create performance_metrics table for aggregated analytics
...
BEGIN
    ...
    -- Calculate current streak using a window function approach
...
-- Create function to update bucket progress
...
BEGIN
    ...
    -- Update or insert bucket progress
...
-- Create function to calculate weekly progress
...
BEGIN
    ...
    -- Get completions for previous week
...
-- Create trigger to update progress when item is completed
...
-- Create trigger to update bucket stats when items are added/removed
