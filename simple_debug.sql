...
-- 1. Check if bucket_collaborators table exists and has data
...
-- 3. Check if buckets table has data
...
-- 4. Test me_user_id function
SELECT 'Step 4: Testing me_user_id function' as step;
SELECT 
    auth.uid() as auth_uid,
    me_user_id() as me_user_id_result;

-- 5. Check if bucket_collaborators table structure is correct
