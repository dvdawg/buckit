...
SET 
    full_name = CASE 
        ...
        WHEN id = '0551092-4b69-4222-bec5-c3627264e6c' THEN 'Cheryl Jones'
        ...
        WHEN id = '08d94a6e-8a04-4d13-8330-b9cc9ffbe5e' THEN 'Frances Miller'
        WHEN id = '0a1278a4-7b5c-47d6-84e9-69fbf8489888' THEN 'Brenda Wilson'
        WHEN id = '0dfd16ba-286a-4e4c-a47e-79b2b3be4bb' THEN 'Joseph Moore'
        WHEN id = '0f26add2-a3b3-4454-a72e-675dd3982de' THEN 'Sean Taylor'
        ...
        WHEN id = '1ca6553d-8d24-441b-8aed-d6f962dd68e' THEN 'Arthur Harris'
    ...
    handle = CASE 
        ...
        WHEN id = '0551092-4b69-4222-bec5-c3627264e6c' THEN 'cheryljones947'
        ...
        WHEN id = '08d94a6e-8a04-4d13-8330-b9cc9ffbe5e' THEN 'francesmiller286'
        WHEN id = '0a1278a4-7b5c-47d6-84e9-69fbf8489888' THEN 'brendawilson795'
        WHEN id = '0dfd16ba-286a-4e4c-a47e-79b2b3be4bb' THEN 'josephmoore399'
        WHEN id = '0f26add2-a3b3-4454-a72e-675dd3982de' THEN 'seantaylor275'
        ...
        WHEN id = '1ca6553d-8d24-441b-8aed-d6f962dd68e' THEN 'arthurharris816'
...
WHERE id IN (
    ...
    '0551092-4b69-4222-bec5-c3627264e6c',
    '07a522aa-08b1-4331-a625-5e5a98d5f48d',
    '07c3cbfc-ca35-449e-847b-fa09c87bc650',
    '08d94a6e-8a04-4d13-8330-b9cc9ffbe5e',
    '0a1278a4-7b5c-47d6-84e9-69fbf8489888',
    '0dfd16ba-286a-4e4c-a47e-79b2b3be4bb',
    '0f26add2-a3b3-4454-a72e-675dd3982de',
    ...
    '1ca6553d-8d24-441b-8aed-d6f962dd68e',
